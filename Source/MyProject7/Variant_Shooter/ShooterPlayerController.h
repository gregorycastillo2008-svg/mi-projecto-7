...
class MYPROJECT7_API AShooterPlayerController : public APlayerController
{
	GENERATED_BODY()

public:

	/** Constructor. Engancha la camara bodycam: sin esto el shooter usaba el
	 *  APlayerCameraManager de serie y no se aplicaba nada del look. */
	AShooterPlayerController();

	/** El Blueprint BP_ShooterPlayerController fija su propio
	 *  PlayerCameraManagerClass y ESE valor pisa al del constructor. Aqui se
	 *  reimpone la camara bodycam justo antes de que el motor la cree. */
