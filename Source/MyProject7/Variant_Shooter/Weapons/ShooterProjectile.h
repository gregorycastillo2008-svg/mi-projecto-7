 ...
 */
UCLASS(abstract)
class MYPROJECT7_API AShooterProjectile : public AActor
{
	GENERATED_BODY()
...
public:
	...
	/** El ARMA decide daño y fuerza al disparar. Asi una escopeta y un rifle
	 *  pueden compartir el mismo proyectil con pegada distinta. */
	void SetHitDamage(float D) { HitDamage = D; }
	void SetPhysicsForce(float F) { PhysicsForce = F; }
